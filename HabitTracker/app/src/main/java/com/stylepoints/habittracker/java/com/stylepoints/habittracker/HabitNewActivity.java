...
/**
 * Contains buttons and intents for the new habit creation screen.
 * The checkboxes correspond to the days to be assigned for a weekly schedule.
 * Then on add habit click, user is required to assign name of habit, reason comment and
 * start date. If exception occurs during this the habit is forcibly evicted from the connector.
 *
 * @author StylePoints
 * @see Habit
 * @version 2017/11/13
