...
/**
 * Contains functions for manipulating a habit, including upper and lower echelon communication,
 * see if a model is occupying the controller and removing it if necessary, connecting the model
 * to the controller abd possible creation of a new habit (throw exception if one is already
 * connected). Also contains some functions for editing a connected habit.
 *
 *
 * @author Qikai Lu
 * @see Habit
...
public class HabitController {
    ...
    public void connectHabit (Habit habit)
    /**
     * Connect to habit
     *
     * @author Qikai Lu
     ...
     *
     */
    { // controller take required model
        if (this.habit == null) {
            this.habit = habit;
        } else {
