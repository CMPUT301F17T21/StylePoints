...
/**
 * Habit class. Contains getters, setters and constructors for a habit.
 * The empty habit is used only to connect to HabitConnector (as yet unwritten).
 * Every habit has a name, reason for creation, start date, weekly schedule and a list
 * of habit events associated with it.
 *
 * @author Niko Somos
 * @see WeekSchedule
 * @version 2017/10/18
